...
cmake \
  ...
  -DSHERPA_ONNX_WASM_VAD_ASR_SKIP_PRELOAD=${SHERPA_ONNX_WASM_VAD_ASR_SKIP_PRELOAD:-OFF} \
  -DSHERPA_ONNX_WASM_VAD_ASR_EXPORT_ES6=${SHERPA_ONNX_WASM_VAD_ASR_EXPORT_ES6:-OFF} \
  ..
make -j2
make install
