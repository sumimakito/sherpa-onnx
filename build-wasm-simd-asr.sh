...
if [ "$SHERPA_ONNX_WASM_ASR_EMIT_TSD" = "ON" ]; then
...
cmake \
  ...
  -DSHERPA_ONNX_WASM_ASR_EXPORT_ES6=${SHERPA_ONNX_WASM_ASR_EXPORT_ES6:-OFF} \
  -DSHERPA_ONNX_WASM_ASR_EMIT_TSD=${SHERPA_ONNX_WASM_ASR_EMIT_TSD:-OFF} \
  -DSHERPA_ONNX_WASM_ASR_SKIP_PRELOAD=${SHERPA_ONNX_WASM_ASR_SKIP_PRELOAD:-OFF} \
  ..
make -j2
make install
